...
Category:  <?php echo e($category->name); ?> - Eat Your Favorite Foods
...
<?php echo e(asset('assets/TokeEmasMitraBaru.png')); ?>
        ...
        <div class="col-md-12">
            ...
            <div>
                <span class="fs-6 fw-bold">
                    ...
                    PRODUCTS IN <span class="text-orange"><?php echo e(strtoupper($category->name)); ?></span>
                </span>
            </div>
            ...
            <div class="row">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $category->produks()->latest()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /var/www/emasv3/resources/views/livewire/web/category/show.blade.php ENDPATH**/ ?>