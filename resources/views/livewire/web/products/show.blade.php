@section('title')
{{ $produk->nama_produk }} - Eat Your Favorite Foods
@stop
...
<div class="container" style="margin-bottom: 200px;">
    <div class="row justify-content-center mt-0">
        <div class="col-md-6">
            ...
            <div class="bg-white rounded-bottom-custom shadow-sm p-3 mb-5" :style="{ backgroundImage: `url({{ asset($produk->linkgambar) }})`,height: '300px',backgroundSize: 'cover',backgroundPosition: 'center'}">
